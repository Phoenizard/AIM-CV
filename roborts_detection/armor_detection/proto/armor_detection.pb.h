...
class ArmorDetectionAlgorithms : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:roborts_detection.ArmorDetectionAlgorithms) */ {
 public:
  ...
  bool has_param_path() const;
  void clear_param_path();
  static const int kParamPathFieldNumber = 7;
  ...
  bool has_bin_path() const;
  void clear_bin_path();
  static const int kBinPathFieldNumber = 8;
  const ::std::string& bin_path() const;
  void set_bin_path(const ::std::string& value);
  #if LANG_CXX11
  void set_bin_path(::std::string&& value);
  #endif
  void set_bin_path(const char* value);
  void set_bin_path(const char* value, size_t size);
  ::std::string* mutable_bin_path();
  ::std::string* release_bin_path();
  void set_allocated_bin_path(::std::string* bin_path);
  ...
  static const int kImageSizeFieldNumber = 9;
  ::google::protobuf::uint32 image_size() const;
  void set_image_size(::google::protobuf::uint32 value);

  // required uint32 num_class = 10;
  bool has_num_class() const;
  void clear_num_class();
  static const int kNumClassFieldNumber = 10;
 ...
 private:
  ...
  void set_has_param_path();
  void clear_has_param_path();
  void set_has_bin_path();
  void clear_has_bin_path();
  ...
  ::google::protobuf::internal::ArenaStringPtr param_path_;
  ::google::protobuf::internal::ArenaStringPtr bin_path_;
...
// required string param_path = 7;
inline bool ArmorDetectionAlgorithms::has_param_path() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void ArmorDetectionAlgorithms::set_has_param_path() {
  _has_bits_[0] |= 0x00000004u;
}
inline void ArmorDetectionAlgorithms::clear_has_param_path() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void ArmorDetectionAlgorithms::clear_param_path() {
  param_path_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  clear_has_param_path();
}
inline const ::std::string& ArmorDetectionAlgorithms::param_path() const {
  // @@protoc_insertion_point(field_get:roborts_detection.ArmorDetectionAlgorithms.param_path)
  return param_path_.GetNoArena();
}
inline void ArmorDetectionAlgorithms::set_param_path(const ::std::string& value) {
  set_has_param_path();
  param_path_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:roborts_detection.ArmorDetectionAlgorithms.param_path)
}
#if LANG_CXX11
inline void ArmorDetectionAlgorithms::set_param_path(::std::string&& value) {
  set_has_param_path();
  param_path_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:roborts_detection.ArmorDetectionAlgorithms.param_path)
}
#endif
inline void ArmorDetectionAlgorithms::set_param_path(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  set_has_param_path();
  param_path_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:roborts_detection.ArmorDetectionAlgorithms.param_path)
}
inline void ArmorDetectionAlgorithms::set_param_path(const char* value, size_t size) {
  set_has_param_path();
  param_path_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:roborts_detection.ArmorDetectionAlgorithms.param_path)
}
inline ::std::string* ArmorDetectionAlgorithms::mutable_param_path() {
  set_has_param_path();
  // @@protoc_insertion_point(field_mutable:roborts_detection.ArmorDetectionAlgorithms.param_path)
  return param_path_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* ArmorDetectionAlgorithms::release_param_path() {
  // @@protoc_insertion_point(field_release:roborts_detection.ArmorDetectionAlgorithms.param_path)
  if (!has_param_path()) {
    return NULL;
  }
  clear_has_param_path();
  return param_path_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void ArmorDetectionAlgorithms::set_allocated_param_path(::std::string* param_path) {
  if (param_path != NULL) {
    set_has_param_path();
  } else {
    clear_has_param_path();
  }
  param_path_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), param_path);
  // @@protoc_insertion_point(field_set_allocated:roborts_detection.ArmorDetectionAlgorithms.param_path)
}

// required string bin_path = 8;
inline bool ArmorDetectionAlgorithms::has_bin_path() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void ArmorDetectionAlgorithms::set_has_bin_path() {
  _has_bits_[0] |= 0x00000008u;
}
inline void ArmorDetectionAlgorithms::clear_has_bin_path() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void ArmorDetectionAlgorithms::clear_bin_path() {
  bin_path_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  clear_has_bin_path();
}
inline const ::std::string& ArmorDetectionAlgorithms::bin_path() const {
  // @@protoc_insertion_point(field_get:roborts_detection.ArmorDetectionAlgorithms.bin_path)
  return bin_path_.GetNoArena();
}
inline void ArmorDetectionAlgorithms::set_bin_path(const ::std::string& value) {
  set_has_bin_path();
  bin_path_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:roborts_detection.ArmorDetectionAlgorithms.bin_path)
}
#if LANG_CXX11
inline void ArmorDetectionAlgorithms::set_bin_path(::std::string&& value) {
  set_has_bin_path();
  bin_path_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:roborts_detection.ArmorDetectionAlgorithms.bin_path)
}
#endif
inline void ArmorDetectionAlgorithms::set_bin_path(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  set_has_bin_path();
  bin_path_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:roborts_detection.ArmorDetectionAlgorithms.bin_path)
}
inline void ArmorDetectionAlgorithms::set_bin_path(const char* value, size_t size) {
  set_has_bin_path();
  bin_path_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:roborts_detection.ArmorDetectionAlgorithms.bin_path)
}
inline ::std::string* ArmorDetectionAlgorithms::mutable_bin_path() {
  set_has_bin_path();
  // @@protoc_insertion_point(field_mutable:roborts_detection.ArmorDetectionAlgorithms.bin_path)
  return bin_path_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* ArmorDetectionAlgorithms::release_bin_path() {
  // @@protoc_insertion_point(field_release:roborts_detection.ArmorDetectionAlgorithms.bin_path)
  if (!has_bin_path()) {
    return NULL;
  }
  clear_has_bin_path();
  return bin_path_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void ArmorDetectionAlgorithms::set_allocated_bin_path(::std::string* bin_path) {
  if (bin_path != NULL) {
    set_has_bin_path();
  } else {
    clear_has_bin_path();
  }
  bin_path_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), bin_path);
  // @@protoc_insertion_point(field_set_allocated:roborts_detection.ArmorDetectionAlgorithms.bin_path)
}

// required uint32 image_size = 9;
inline bool ArmorDetectionAlgorithms::has_image_size() const {
  return (_has_bits_[0] & 0x00000080u) != 0;
}
inline void ArmorDetectionAlgorithms::set_has_image_size() {
  _has_bits_[0] |= 0x00000080u;
}
inline void ArmorDetectionAlgorithms::clear_has_image_size() {
  _has_bits_[0] &= ~0x00000080u;
}
inline void ArmorDetectionAlgorithms::clear_image_size() {
  image_size_ = 0u;
  clear_has_image_size();
}
inline ::google::protobuf::uint32 ArmorDetectionAlgorithms::image_size() const {
  // @@protoc_insertion_point(field_get:roborts_detection.ArmorDetectionAlgorithms.image_size)
  return image_size_;
}
inline void ArmorDetectionAlgorithms::set_image_size(::google::protobuf::uint32 value) {
  set_has_image_size();
  image_size_ = value;
  // @@protoc_insertion_point(field_set:roborts_detection.ArmorDetectionAlgorithms.image_size)
}

// required uint32 num_class = 10;
inline bool ArmorDetectionAlgorithms::has_num_class() const {
  return (_has_bits_[0] & 0x00000100u) != 0;
}
inline void ArmorDetectionAlgorithms::set_has_num_class() {
  _has_bits_[0] |= 0x00000100u;
}
inline void ArmorDetectionAlgorithms::clear_has_num_class() {
  _has_bits_[0] &= ~0x00000100u;
}
inline void ArmorDetectionAlgorithms::clear_num_class() {
  num_class_ = 0u;
  clear_has_num_class();
}
inline ::google::protobuf::uint32 ArmorDetectionAlgorithms::num_class() const {
  // @@protoc_insertion_point(field_get:roborts_detection.ArmorDetectionAlgorithms.num_class)
  return num_class_;
}
inline void ArmorDetectionAlgorithms::set_num_class(::google::protobuf::uint32 value) {
  set_has_num_class();
  num_class_ = value;
  // @@protoc_insertion_point(field_set:roborts_detection.ArmorDetectionAlgorithms.num_class)
}
