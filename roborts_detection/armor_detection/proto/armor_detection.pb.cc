...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::roborts_detection::ArmorDetectionAlgorithms, param_path_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::roborts_detection::ArmorDetectionAlgorithms, bin_path_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::roborts_detection::ArmorDetectionAlgorithms, image_size_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::roborts_detection::ArmorDetectionAlgorithms, num_class_),
  ~0u,
  0,
  6,
  1,
...
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 24, 39, sizeof(::roborts_detection::ArmorDetectionAlgorithms)},
};
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      ...
      "(\002\022\016\n\006init_k\030\002 \001(\002\"\330\002\n\030ArmorDetectionAlg"
      ...
      "odelInfo\022\022\n\nparam_path\030\007 \002(\t\022\020\n\010bin_path"
      "\030\010 \002(\t\022\022\n\nimage_size\030\t \002(\r\022\021\n\tnum_class\030"
      "\n \002(\r"
  };
...
const int ArmorDetectionAlgorithms::kParamPathFieldNumber;
const int ArmorDetectionAlgorithms::kBinPathFieldNumber;
const int ArmorDetectionAlgorithms::kImageSizeFieldNumber;
const int ArmorDetectionAlgorithms::kNumClassFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900
...
ArmorDetectionAlgorithms::ArmorDetectionAlgorithms(const ArmorDetectionAlgorithms& from)
  ...
  param_path_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  if (from.has_param_path()) {
    param_path_.AssignWithDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), from.param_path_);
  }
  bin_path_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  if (from.has_bin_path()) {
    bin_path_.AssignWithDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), from.bin_path_);
  }
  ...
  ::memcpy(&undetected_armor_delay_, &from.undetected_armor_delay_,
    static_cast<size_t>(reinterpret_cast<char*>(&num_class_) -
    reinterpret_cast<char*>(&undetected_armor_delay_)) + sizeof(num_class_));
...
void ArmorDetectionAlgorithms::SharedCtor() {
  ...
  ::memset(&camera_gimbal_transform_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&num_class_) -
      reinterpret_cast<char*>(&camera_gimbal_transform_)) + sizeof(num_class_));
}
...
void ArmorDetectionAlgorithms::SharedDtor() {
  ...
  param_path_.DestroyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  bin_path_.DestroyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
...
// @@protoc_insertion_point(message_clear_start:roborts_detection.ArmorDetectionAlgorithms)
  ...
  if (cached_has_bits & 63u) {
    ...
    if (cached_has_bits & 0x00000004u) {
      param_path_.ClearNonDefaultToEmptyNoArena();
    }
    if (cached_has_bits & 0x00000008u) {
      bin_path_.ClearNonDefaultToEmptyNoArena();
    }
    if (cached_has_bits & 0x00000010u) {
  ...
  if (cached_has_bits & 192u) {
    ::memset(&undetected_armor_delay_, 0, static_cast<size_t>(
        ...
        reinterpret_cast<char*>(&undetected_armor_delay_)) + sizeof(image_size_));
  }
  num_class_ = 0u;
  _has_bits_.Clear();
  _internal_metadata_.Clear();
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 7: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_(::google::protobuf::internal::WireFormatLite::ReadString(
                input, this->mutable_param_path()));
          ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
            this->param_path().data(), static_cast<int>(this->param_path().length()),
            ::google::protobuf::internal::WireFormat::PARSE,
            "roborts_detection.ArmorDetectionAlgorithms.param_path");
        } else {
          goto handle_unusual;
        }
        break;
      ...
      case 8: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_(::google::protobuf::internal::WireFormatLite::ReadString(
                input, this->mutable_bin_path()));
          ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
            this->bin_path().data(), static_cast<int>(this->bin_path().length()),
            ::google::protobuf::internal::WireFormat::PARSE,
            "roborts_detection.ArmorDetectionAlgorithms.bin_path");
        } else {
          goto handle_unusual;
        }
        break;
...
void ArmorDetectionAlgorithms::SerializeWithCachedSizes(
  ...
  if (cached_has_bits & 0x00000008u) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      ...
      "roborts_detection.ArmorDetectionAlgorithms.bin_path");
    ::google::protobuf::internal::WireFormatLite::WriteStringMaybeAliased(
      8, this->bin_path(), output);
  }

  // required uint32 image_size = 9;
  if (cached_has_bits & 0x00000080u) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(9, this->image_size(), output);
  }

  // required uint32 num_class = 10;
  if (cached_has_bits & 0x00000100u) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(10, this->num_class(), output);
  }
...
::google::protobuf::uint8* ArmorDetectionAlgorithms::InternalSerializeWithCachedSizesToArray(
  ...
  if (cached_has_bits & 0x00000008u) {
    ...
    target =
      ::google::protobuf::internal::WireFormatLite::WriteStringToArray(
        8, this->bin_path(), target);
  }

  // required uint32 image_size = 9;
  if (cached_has_bits & 0x00000080u) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(9, this->image_size(), target);
  }

  // required uint32 num_class = 10;
  if (cached_has_bits & 0x00000100u) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(10, this->num_class(), target);
  }
...
size_t ArmorDetectionAlgorithms::RequiredFieldsByteSizeFallback() const {
// @@protoc_insertion_point(required_fields_byte_size_fallback_start:roborts_detection.ArmorDetectionAlgorithms)
  size_t total_size = 0;
...
// @@protoc_insertion_point(message_byte_size_start:roborts_detection.ArmorDetectionAlgorithms)
  ...
  if (((_has_bits_[0] & 0x0000019c) ^ 0x0000019c) == 0) {  // All required fields are present.
    // required string param_path = 7;
    total_size += 1 +
      ::google::protobuf::internal::WireFormatLite::StringSize(
        this->param_path());
...
bool ArmorDetectionAlgorithms::IsInitialized() const {
  if ((_has_bits_[0] & 0x0000019c) != 0x0000019c) return false;
  if (has_camera_gimbal_transform()) {
...
void ArmorDetectionAlgorithms::InternalSwap(ArmorDetectionAlgorithms* other) {
  ...
  camera_name_.Swap(&other->camera_name_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
  param_path_.Swap(&other->param_path_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
  bin_path_.Swap(&other->bin_path_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
