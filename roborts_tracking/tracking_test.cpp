...
int main(int argc, char** argv)
{
  ...
  int img_width = 640;
  int img_height = 480;
  video.set(CAP_PROP_FRAME_WIDTH,img_width);
  video.set(CAP_PROP_FRAME_HEIGHT,img_height);
  img_width = video.get(CAP_PROP_FRAME_WIDTH);
  img_height = video.get(CAP_PROP_FRAME_HEIGHT);
